...
ALTER DATABASE NYSIFDB
MODIFY FILE (NAME = NYSIFDB, FILENAME = 'D:\MSSQL\DATA\NYSIFDB.mdf', SIZE = 100MB, MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
GO

ALTER DATABASE NYSIFDB
MODIFY FILE (NAME = NYSIFDB_Log, FILENAME = 'D:\MSSQL\LOG\NYSIFDB.ldf', SIZE = 50MB, MAXSIZE = UNLIMITED, FILEGROWTH = 5MB);
GO
